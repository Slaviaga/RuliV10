   ...
   // anticall auto block
	...
	conn.ev.on("groups.update", async (json) => {
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://instagram.com/zhyaricszervas",
                            mediaType: 1,
        ...
        try {
            ...
            for (let num of participants) {
               ...
               if (anu.action == 'add') {
                 let a = `*Hello @${num.split("@")[0]}, Aku Rena. 👋 Welcome To ${metadata.subject}*\n*Kami Harap Kamu Merasa Nyaman Di Grup Ini Dan Jangan Lupa Membaca Deskripsi Grup Ya (⁠ ⁠╹⁠▽⁠╹⁠ ⁠)*\n\n┌───⊷ *INTRO*\n▢ *Nama* :\n▢ *Gender* :\n▢ *Kelas* :\n▢ *Domisili* :\n▢ *Waifu/Husbu* :\n└──────────────`
     ...
     text: a, 
      contextInfo: {
         ...
         renderLargerThumbnail: true
                    ...
                    let a = `Congratulations @${num.split("@")[0]}, Kamu telah dipromosikan menjadi admin di grup ${metadata.subject} 🎉`
                    conn.sendMessage(anu.id, {
     text: a, 
      contextInfo: {
         externalAdReply: {
     ...
     text: a, 
      contextInfo: {
         ...
         renderLargerThumbnail: true
            ...
            console.log("Error Di Bagian Welcome Group "+err)
        }
    })
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${namaowner}\nFN:${namaowner}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:el.slaviaga47@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/zhyaricszervas\nitem3.X-ABLabel:Panel\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
...
try{
		if (connection === 'close') {
			...
			if (reason === DisconnectReason.badSession) {
				...
				console.log("Connection closed, rena reconnecting....");
				startAdrian();
			} else if (reason === DisconnectReason.connectionLost) {
				console.log("Connection Lost from Server, rena reconnecting...");
				startAdrian();
				...
				console.log("Restart Required, Rena Restarting...");
				startAdrian();
			} else if (reason === DisconnectReason.timedOut) {
				console.log("Connection TimedOut, Rena Reconnecting...");
				startAdrian();
			} else conn.end(`Unknown DisconnectReason: ${reason}|${connection}`)
		} else if (connection === "open") { conn.sendMessage(owo + "@s.whatsapp.net", { text: `*Rena Started!*\n\n• *Ruli V.10*\n\n*Instagram:*\nhttps://instagram.com/zhyaricszervas` }); }
		if (update.connection == "connecting" || update.receivedPendingNotifications == "false") {
			lolcatjs.fromString(`[Rena Trying To Connect . . .]`)
		}
